...
export default function page() {
    return (
        ...
        <div className={"w-full hw-full"}>

            <div className="max-w-4xl min-h-screen mt-22 pt-32  mx-auto p-6 text-white rounded-lg shadow-lg">
                <h1 className="text-4xl font-bold mb-4">BT-POOL 2024 Overview: Hashrate Steadily Increased, Multi-Coin
                    Pools Maintained a Leading Global Position</h1>
                <p className="text-sm text-gray-500 mb-4">{"2024/01/06"}</p>
                <p className="text-gray-400 text-lg leading-8 ">The approval of a U.S. spot ETF, the Federal Reserve’s
                    shift to an interest
                    rate cutting cycle, and Donald Trump’s successful election win have driven Bitcoin to break the
                    $100,000 mark over the past year. Crypto has become the central theme of the global financial market
                    in 2024. Additionally, Bitcoin completed its fourth halving in April 2024, further reinforcing its
                    scarcity and marking a new development cycle for the crypto mining industry.
                ...
                <Link href="/blog" className="text-blue-500 hover:underline mt-6 block">Back to Blog</Link>
            </div>
        </div>
